...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-bkj-yvg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-bkj-yvg.containers.anotherwebservice.com/
...
```
git clone git@github.com:Kobbyy1739/container-bkj-yvg.git
cd container-bkj-yvg
```
...
```
docker attach container-bkj-yvg
```
